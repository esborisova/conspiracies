...
from conspiracies.relationextraction import SpacyRelationExtractor  # noqa

from .utils import nlp_da  # noqa


def test_relationextraction_component_pipe(nlp_da):
    ...
    # change these to your purposes. 2.5 is the default confidence threshold(the bulk of bad relations not kept and the majority of correct ones kept)
...
def test_relation_extraction_component_single(nlp_da):
